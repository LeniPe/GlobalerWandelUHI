...
library(dplyr)
data <- read.table("G:/Studium_Geographie/MSc_Physische_Geographie/Kurse/Globaler Wandel/Stadtklima in Marburg/Lokaler_Teil/Coelbe_Wetterstation/produkt_klima_monat_18810101_20191231_03164.txt", header = T, dec = ".", sep = ";")
...
saveRDS(lang_Mittel, "G:/Studium_Geographie/MSc_Physische_Geographie/Kurse/Globaler Wandel/Stadtklima in Marburg/Lokaler_Teil/Coelbe_Wetterstation/lang_Mittel.rds")
...
saveRDS(DF_Sommer_Mittelwerte, 
        "G:/Studium_Geographie/MSc_Physische_Geographie/Kurse/Globaler Wandel/Stadtklima in Marburg/Lokaler_Teil/Coelbe_Wetterstation/Mittelwerte_Sommer.rds")
...
main  = "Mittlerer Niederschlag der Sommermonate /n Juni, Juli und August in Coelbe /n (rote Linie = langjaehriges Mittel von 1988-2018)",
col = "darkblue")
...
df_bar <- barplot(DF_Sommer_Mittelwerte$Temperatur,
                  ...
                  xlab = "Jahr",
                  names.arg = c("2000", "2006", "2012", "2018"),
                  main  = "Mittlerer Temperatur der Sommermonate /n Juni, Juli und August in Coelbe /n (rote Linie = langjaehriges Mittel von 1988-2018)",
                  col = "orange")
